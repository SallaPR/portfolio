        ...
        <div className="about-container">
          <div className="about-content">
            <p>
              ...
              Sciences. I enjoy working on both front-end and back-end technologies,
              trying out new frameworks, and learning how different technologies interact.
            </p>
            <p>
          ...
          <div className="about-image">
            <img src={`${process.env.PUBLIC_URL}/images/pfp.jpeg`} alt="Profile photo" />
          </div>
        </div>
      </section>
